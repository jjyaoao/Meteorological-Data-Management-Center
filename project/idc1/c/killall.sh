...
killall -9 procctl
killall gzipfiles crtsurfdata deletefiles ftpgetfiles ftpputfiles tcpputfiles fileserver
...
killall -9 gzipfiles crtsurfdata deletefiles ftpgetfiles ftpputfiles tcpgetfiles fileserver
